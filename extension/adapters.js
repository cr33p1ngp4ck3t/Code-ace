(() => {
  const adapters = [
    ...
    { name: 'LinkedIn', hosts: ['www.linkedin.com', 'linkedin.com'], posts: '.feed-shared-update-v2, .occludable-update, [data-urn^="urn:li:activity:"]', text: '.update-components-text, .feed-shared-update-v2__description, .feed-shared-text', images: 'img', permalink: 'a[href*="/feed/update/"], a[href*="/posts/"]' },
